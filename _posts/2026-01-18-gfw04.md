...
[中文版本](https://medium.com/@xnvlnasna/gfw-深度解析-04-西厢计划-da1936739ab4){:target="_blank"}
...
<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw04/tcp_state.png" width="70%">
...
<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw04/zhang.png" width="85%">
...
<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw04/cui.png" width="85%">
...
* Packet reordering: deliberately sending packets out of order to confuse the GFW's reassembly logic, while the server reassembles them correctly
...
<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw04/resync.png" width="80%">
...
* Tcp state diagram. Wikipedia. <https://en.wikipedia.org/wiki/File:Tcp_state_diagram.png>