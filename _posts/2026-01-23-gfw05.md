...
[中文版本](https://medium.com/@xnvlnasna/gfw深度解析-05-shadowsocks-c402b76d87b2){:target="_blank"}
...
Since this process is deterministic, using the master key alone would produce identical ciphertext from identical plaintext. The IV adds the randomness needed for different encryptions of the same data to yield different ciphertext.
