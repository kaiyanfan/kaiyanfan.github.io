...
This modern stack eliminates most protocol-level fingerprints. The GFW's traditional TLS fingerprinting methods no longer work against it. However, the behavioral and contextual signals remain. No transport-layer protocol improvement can address the fundamental issue of IP address reputation. That is not a problem protocol designers can solve. It is something operators must account for.
