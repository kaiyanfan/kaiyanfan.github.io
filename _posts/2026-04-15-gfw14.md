...
[中文版本](https://medium.com/@xnvlnasna/gfw-深度解析-14-猫鼠游戏-60f00d87b49a){:target="_blank"}

<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw14/cover.png" width="70%">
</figure>
...
Mathematics, however, sits squarely on the circumvention community's side. Encryption is computationally simpler than decryption; obfuscation is simpler than classification. These are inherent mathematical properties, and they are the core reason the circumvention community has been able to keep up the fight.

##### Cost

The cost of making mistakes is another asymmetry that favors the circumvention community. When the GFW blocks a connection, it risks collateral damage: disrupting legitimate traffic, breaking business services, degrading the internet experience for ordinary users. When a circumvention tool fails, the cost is borne by individual users who temporarily lose access. The GFW must be conservative because its errors are visible and politically costly; the circumvention community can be experimental because its failures are private and recoverable.
...
<figure style="text-align:center;">
    <img src="/assets/img/posts/gfw14/roc.png" width="60%">
