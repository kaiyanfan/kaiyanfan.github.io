...
<figure style="text-align:center;">
    ...
    <figcaption>Shadowsocks packet format in stream cipher mode</figcaption>
</figure>
...
Shadowsocks supports over a dozen stream cipher schemes with varying security and performance characteristics, but they all follow this same fundamental process.
...
<figure style="text-align:center;">
    ...
    <figcaption>Shadowsocks packet format in AEAD cipher+TCP mode</figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>AEAD Encryption</figcaption>
</figure>
